...
namespace mystl
{
    ...
    // advance的bidirecitonal_iterator_tag的版本
    ...
    // advance的andom_access_iterator_tag的版本
    template <class RandomIter, class Distance>
    void advance_dispatch(RandomIter &i, Distance n, mystl::random_access_iterator_tag)
    {
        i += n;
    }
