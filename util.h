...
namespace mystl
{
    ...
    {
        return static_cast<typename <T>::type &&>(arg);
    }
    ...
    struct pair
    {
        ...
        template <class U1 = Ty1, class U2 = Ty2,
                  typename std::enable_if<
                      std::is_copy_constructiable<U1>::value &&
        ...
        template <class U1 = Ty1, class U2 = Ty2,
                  typename std::enable_if<
                      std::is_copy_constructible<U1>::value &&
                          std::is_cpoy_constructible<U2>::value &&
                          (!std::is_convertible<const U1 &, Ty1>::value ||
                           !std::is_convertible<const U2 &, Ty2>::value >),
                      int>::type = 0>
        ...
        template <class Other1, class Other2,
                  typename std::enable_if<
                      ...
                      int>::type = 0>
        constexpr pair(const pair<Other1, Other2> &other)
            : first(mystl::forawrd<Other1>(other.first)),
              second(mystl::forawrd<Other2>(other.second))
        {
        }
